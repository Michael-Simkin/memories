---
name: validate-aspect
description: >
  Search past session transcripts for rules and preferences about ONE specific
  implementation aspect. Returns a structured rulebook. This skill runs as a
  forked subagent — invoke it from /validate or directly with an aspect argument
  like: /validate-aspect testing
context: fork
