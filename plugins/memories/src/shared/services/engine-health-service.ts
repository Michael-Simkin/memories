...
import type {
  EngineHealth,
  EngineHealthCompatibilityResult,
} from "../types/health.js";

export class EngineHealthService {
  static createExpectedHealth(dbSchemaVersion: number): EngineHealth {
  ...
  static parseHealth(value: unknown): EngineHealth {
  ...
  static evaluateCompatibility(
    ...
    if (
      actualHealth.api_contract_version !== expectedHealth.api_contract_version
    ) {
      return {
        isCompatible: false,
